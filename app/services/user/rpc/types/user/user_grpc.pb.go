...
func (c *userClient) GetUserByUUID(ctx context.Context, in *UUIDRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
	err := c.cc.Invoke(ctx, "/user.User/getUserByUUID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	GetUserByUUID(context.Context, *UUIDRequest) (*UserResponse, error)
...
func (UnimplementedUserServer) GetUserByUUID(context.Context, *UUIDRequest) (*UserResponse, error) {
...
func _User_GetUserByUUID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.User/getUserByUUID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserByUUID(ctx, req.(*UUIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
